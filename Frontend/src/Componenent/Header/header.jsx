...
import { FaBell, FaPlus, FaUser, FaYoutube } from "react-icons/fa";
    ...
    <header className="shadow sticky z-50 top-0">
      <nav className="border-gray-200 px-4 lg:px-6 py-2.5 sm:bg-blue-50 lg:bg-slate-50 font-bold">
        <div className="flex justify-between items-center">
          <div><FaYoutube size={32} color="red"/></div>
          ...
          <div>
            <div className="flex gap-8">
              <button className="flex gap-2 text-sm p-2 w-24 bg-slate-200 hover:bg-slate-300 rounded-3xl items-center"><FaPlus size={16}/>Create</button>
              <button className="rounded-2xl p-3 hover:bg-slate-200"><FaBell size={20} /></button>
